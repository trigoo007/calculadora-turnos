...
Acepta fechas como argumentos en línea de comando
"""
...
def main():
    ...
    if len(sys.argv) < 3:
        print("Uso: python3 procesar_fechas_arg.py <ruta_archivo_csv> <fecha1>[,F] [<fecha2>[,F] ...] [output_dir] [nombre_doctor]")
        print("Ejemplo: python3 procesar_fechas_arg.py data.csv 08-abr-2025 09-abr-2025,F")
    ...
    print(f"Fechas a procesar: {fechas_arg}")
